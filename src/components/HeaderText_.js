    ...
    <HeroWrapper>
        <div className="hero-text">
            <div className="css-typing">
                <p>
                  <span style={{color: `${styles.colors.yellow}` }}>
                  if
                  </span>
                  <span style={{color: `${styles.colors.darkOrange}` }}>
                  &#40;
                  </span>
                  <span style={{color: `${styles.colors.primaryColor}` }}>
                  life
                  </span>
                  .
...
.css-typing p:nth-child(1) {
  width: 19.2em;
  -webkit-animation: type 7s steps(32, end), blink 0.5s step-end infinite alternate;
...
.css-typing p:nth-child(2) {
  width: 15em;
  opacity: 0;
  -webkit-animation: type2 5s steps(25, end), blink 0.5s step-end infinite alternate;
...
.css-typing p:nth-child(3) {
  width: 0.5em;
  opacity: 0;
  -webkit-animation: type3 1s steps(1, end), blink 0.5s step-end infinite alternate;
